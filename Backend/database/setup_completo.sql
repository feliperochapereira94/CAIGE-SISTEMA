-- =====================================================================
-- CAIGE SISTEMA — SETUP COMPLETO (PT-BR)
-- =====================================================================
...
INSERT IGNORE INTO usuarios (email, senha_hash, nome, papel, setor, ativo, oculto)
VALUES
  (
    'professor.caige@univale.br',
    '$2a$10$Ji4DeFj5XiJePFMlwsMCRedwAYHg/uV/z8KOL72ZmCNKkslkQ/yXS',
    'Professor CAIGE',
    'PROFESSOR',
    'Fisioterapia',
...
INSERT IGNORE INTO profissionais (nome) VALUES
  ('Prof. Camila Nunes'),
  ('Prof. Rafael Souza');

INSERT IGNORE INTO pacientes
  (nome, data_nascimento, genero, cpf, telefone, celular, cep, rua, numero, bairro, cidade, estado, responsavel, parentesco_responsavel, telefone_responsavel, observacoes, status)
VALUES
  ('Ana Silva', '1958-02-10', 'Feminino', '111.222.333-44', '(31) 3333-4444', '(31) 98888-1111', '35000-000', 'Rua das Flores', '120', 'Centro', 'Governador Valadares', 'MG', 'Joao Silva', 'Filho', '(31) 97777-1111', 'Paciente de teste do ambiente completo', 'ativo'),
  ('Carlos Pereira', '1961-09-23', 'Masculino', '222.333.444-55', '(31) 3222-1111', '(31) 96666-2222', '35000-001', 'Av. Minas', '450', 'Lourdes', 'Governador Valadares', 'MG', 'Maria Pereira', 'Esposa', '(31) 95555-2222', 'Acompanhamento semanal', 'ativo');

INSERT IGNORE INTO atividades (tipo, descricao, responsavel)
VALUES
  ('Paciente', 'Pacientes de teste cadastrados no setup completo', 'Sistema'),
  ('Sistema', 'Base inicial com dados de teste criada', 'Sistema');

INSERT IGNORE INTO frequencia (id_paciente, id_profissional, hora_entrada, data_frequencia, observacoes)
VALUES
  (1, 1, '2026-01-10 08:30:00', '2026-01-10', 'Atendimento inicial'),
  (2, 2, '2026-01-10 09:10:00', '2026-01-10', 'Retorno agendado');

INSERT IGNORE INTO perguntas (titulo, descricao, tipo_pergunta, opcoes, criado_por, curso, ativo)
VALUES
  ('Nivel de dor atual', 'Escala de 0 a 10', 'escala', NULL, 1, 'Fisioterapia', TRUE),
  ('Consegue realizar atividades diarias?', 'Resposta objetiva', 'sim_nao', NULL, 1, 'Fisioterapia', TRUE),
  ('Queixa principal', 'Descreva com detalhes', 'texto_livre', NULL, 1, 'Fisioterapia', TRUE);

INSERT IGNORE INTO questionarios (titulo, descricao, curso, criado_por, publicado)
VALUES
  ('Triagem inicial de fisioterapia', 'Questionario base para primeira consulta', 'Fisioterapia', 1, TRUE);

INSERT IGNORE INTO questoes_questionarios (id_questionario, id_pergunta, ordem_pergunta, ativo)
VALUES
  (1, 1, 1, TRUE),
  (1, 2, 2, TRUE),
  (1, 3, 3, TRUE);

INSERT IGNORE INTO respostas_questionarios (id_paciente, id_questionario, dados_resposta)
VALUES
  (
    1,
    1,
    JSON_OBJECT(
      '1', JSON_OBJECT('titulo', 'Nivel de dor atual', 'tipo_pergunta', 'escala', 'resposta', '6'),
      '2', JSON_OBJECT('titulo', 'Consegue realizar atividades diarias?', 'tipo_pergunta', 'sim_nao', 'resposta', 'sim'),
      '3', JSON_OBJECT('titulo', 'Queixa principal', 'tipo_pergunta', 'texto_livre', 'resposta', 'Dor lombar ao caminhar')
    )
  );

INSERT IGNORE INTO estatisticas_rapidas (rotulo, valor)
VALUES
  ('Pacientes ativos', '2'),
  ('Questionarios publicados', '1');
